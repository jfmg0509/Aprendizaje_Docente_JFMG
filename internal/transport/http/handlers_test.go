...
func TestAPICreateUser(t *testing.T) {
    ...
    h := NewHandlers(userSvc, bookSvc, tpl)
    srv := NewServer(h)
...
func (r *memUserRepo) GetByID(ctx context.Context, id uint64) (*domain.User, error) {
    r.mu.Lock(); defer r.mu.Unlock()
    u, ok := r.byID[id]; if !ok { return nil, domain.ErrNotFound }
    return u, nil
}
func (r *memUserRepo) GetByEmail(ctx context.Context, email string) (*domain.User, error) {
    r.mu.Lock(); defer r.mu.Unlock()
    id, ok := r.byEmail[email]; if !ok { return nil, domain.ErrNotFound }
...
func (r *memBookRepo) GetByID(ctx context.Context, id uint64) (*domain.Book, error) { return nil, domain.ErrNotFound }
func (r *memBookRepo) GetByISBN(ctx context.Context, isbn string) (*domain.Book, error) { return nil, domain.ErrNotFound }
func (r *memBookRepo) List(ctx context.Context) ([]*domain.Book, error) { return nil, nil }
func (r *memBookRepo) Search(ctx context.Context, f domain.BookFilter) ([]*domain.Book, error) { return nil, nil }
...
func (r *memAccessRepo) Create(ctx context.Context, e *domain.AccessEvent) (uint64, error) { return 1, nil }
